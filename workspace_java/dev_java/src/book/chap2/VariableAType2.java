...
출력)  지구몸무게  : 100
          달 몸무게 : 17kg
*************************************************************************************************/
public class VariableAType2 {
	double mwg;//달의 몸무게
	double ewg;//지구의 몸무게
	//달의 몸무게를 계산하는 메소드를 선언하고 구현하시오.
	double moonWeight() {//파라미터가 없다
		mwg = (ewg*17)/100;//타입이 없어졌다.
		return mwg;
	}
	public static void main(String[] args) {
		System.out.println("지구의 몸무게를 입력하세요.");
		Scanner scan = new Scanner(System.in);
		VariableAType2 vat = new VariableAType2();
		vat.ewg = scan.nextDouble();
		vat.mwg = vat.moonWeight();
		System.out.println("달의 몸무게는 ===> "+vat.mwg);
	}
}
