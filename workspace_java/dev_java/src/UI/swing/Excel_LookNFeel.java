...
class Excel_Test22 extends JInternalFrame
{
	...
	public Excel_Test22(String str,boolean a, boolean b, boolean c, boolean d){
		super(str,a,b,c,d);
		this.init();
		this.start();
...
class Excel_Test11 extends JFrame implements ActionListener{
	private JRootPane jrp;
	private Container con;
	//메뉴바생성
	...
	public void actionPerformed(ActionEvent e){
		if(e.getSource() == fnew || e.getSource() == jbt){
			Excel_Test22 et2 = new Excel_Test22("제목"+ ++num,true,true,true,true);
...
public class Excel_LookNFeel{
	
	public static void main(String args[]){
		try{
			UIManager.setLookAndFeel(UIManager.getSystemLookAndFeelClassName());
		}catch(Exception e){}
		Excel_Test11 et = new Excel_Test11();
	}
}
